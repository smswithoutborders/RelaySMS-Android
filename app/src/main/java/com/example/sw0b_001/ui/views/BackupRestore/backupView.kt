...
fun BackupView() {
    ...
    Scaffold(
        ...
        Box(
            ...
            when (currentStep) {
                0 -> BackupIntroScreen(onNext = { currentStep = 1 })
                1 -> RecoveryKeyInfoScreen(onNext = { currentStep = 2 })
                2 -> RecoveryKeyScreen(onDone = { /* Handle completion */ })
            }
        }
    }
}
